...
- Requirement 8: ECDSA Signature should be sent out in Authentication
  payload

**Use Case 4:** As a responder, I should respond to IKE AUTH messages
with ecdsa support.
...
- Requirement 11: If ECDSA Signature verification fails, IKE AUTH
  failure is sent.
